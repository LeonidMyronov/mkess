  ...
  private energyServices = [
    {
      ...
      description: [
          "ООО «Энергоконтракт Плюс» выполняет полный комплекс услуг по проектированию объектов электроэнергетики классом напряжения до 330 кВ включительно"
      ],
      detailedDescriptions: [
          ...
          "ООО «Энергоконтракт Плюс» готово выполнить следующие виды работ:"
      ],
      titledWorksList: [
        {
    ...
    },
    {
      ...
      description: [
        "Производственный участок ООО «Энергоконтракт Плюс» поможет Вам качественно выполнить широкий спектр строительно-монтажных работ. Благодаря слаженной работе всех структурных единиц нашей компании Вы сможете в сжатые сроки реализовать свои планы по выполнению всех видов работ"
      ],
      detailedDescriptions: [
        "Производственный участок ООО «Энергоконтракт Плюс» поможет Вам качественно выполнить широкий спектр строительно-монтажных работ. Благодаря слаженной работе всех структурных единиц нашей компании Вы сможете в сжатые сроки реализовать свои планы по выполнению всех видов работ:"
      ],
...

    {
      ...
      description: [
        "Специалисты ООО «Энергоконтракт Плюс» помогут Вам быть более уверенными в получении исчерпывающей информации по изменениям в нормативно-правовой базе и ценообразованию в электроэнергетической сфере"
      ],
      detailedDescriptions: [
        "Специалисты ООО «Энергоконтракт Плюс» помогут Вам быть более уверенными в получении исчерпывающей информации по изменениям в нормативно-правовой базе и ценообразованию в электроэнергетической сфере. А именно:"
      ],
      titledWorksList: [],
      worksList: [
  ...
  private homeMenu = [
    {
      ...
      url: "about-us",
      content: [
        "Деятельность ООО «Энергоконтракт Плюс» направлена на оказание помощи частным лицам и коммерческим структурам в обеспечении энергетики, пожарной и техногенной безопасности, выявлении проблемных моментов и разработке нормативно-обоснованных экономически выгодных путей решения проблем.",
  ...
  private fireSafetyServices = [
    {
      ...
      description: [
        "Проектая группа ООО «Энергоконтракт Плюс» поможет Вам в разработке документации по обеспечению пожарной и техногенной безопасности и выполнит все необходимые работы"
      ],
      titledList: [
        {
    ...
    },
    {
      ...
      description: [
        "Расчетно-проектая группа ООО «Энергоконтракт Плюс», основываясь на полной нормативной базе, выполнит все необходимые расчеты по обеспечению пожарной и техногенной безопасности"
      ],
      worksList: [
    ...
    },
    {
      ...
      description: [
        "Специалисты ООО «Энергоконтракт Плюс», основываясь на финансово-правовой базе, предоставят Вам всю необходимую информацию для сокращения Ваших затрат в реализации пожарной и техногенной безопасности предприятия"
      ],
      worksList: [
    ...
    },
    {
      ...
      description: [
        "Специалисты ООО «Энергоконтракт Плюс» окажут свою профессиональную юридическую помощь в защите Ваших интересов и законных прав"
      ],
      worksList: [
